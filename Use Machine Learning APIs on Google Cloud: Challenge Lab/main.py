...
for file in files:
    if file.name.endswith('jpg') or  file.name.endswith('png'):
        ...
        target_languages = {
            '': 'en',   # Default to English if no locale is detected
        ...
        target_language = target_languages.get(locale, 'en')
        if locale == '':
            ...
            translation = translate_client.translate(desc, target_language=target_language)
